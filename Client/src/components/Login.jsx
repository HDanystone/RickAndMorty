...
const handleSubmit= (event) =>{
    ...
    function validate(errores) {
        ...
        if(errores.password){   
            ...
            'ingresa al menos 1 número, 1 caracter especial y longitud de ente 6 y 10 caracteres'
               : ''
    ...
    return(
        <div className="login" > 
            ...
            <form onSubmit = {handleSubmit}>
                ...
                <span className ='lblmsg'>{userErrors.email && userErrors.email}</span>
                ...
                <input
                    ...
                    <span className='lblmsg'>{userErrors.password && userErrors.password}</span>
